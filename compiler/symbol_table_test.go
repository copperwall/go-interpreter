	...
	tests := []struct {
		...
		},
		{
			...
			[]Symbol{
				...
				// TODO: Add resolve test case for c and d for nested behavior?
			},
		},
	}
...
func TestDefineAndResolveFunctionName(t *testing.T) {
	...
	if !ok {
		t.Fatalf("function name %s not resolveable", expected.Name)
	}
...
func TestFunctionShadowing(t *testing.T) {
	global := NewSymbolTable()
	global.DefineFunctionName("a")
	global.Define("a")
